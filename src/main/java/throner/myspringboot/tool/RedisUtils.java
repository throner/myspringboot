...
public class RedisUtils {
     ...
     * @return 成功个数
     */
    public static long set(String key, Object...values) {
        try {
     ...
     * @return 成功个数
     */
    public static  long setAndTime(String key,long time,Object...values) {
        try {
     ...
     * @return
     */
    public static  List<Object> get(String key, long start, long end){
        try {
     ...
     * @return
     */
    public static  Object getIndex(String key,long index){
        try {
     ...
     * @return
     */
    public static  boolean set(String key, List<Object> value) {
        try {
     ...
     * @return
     */
    public static  boolean set(String key, List<Object> value, long time) {
        try {
            redisTemplate.opsForList().rightPushAll(key, value);
            if (time > 0) {
                expire(key, time);
     ...
     * @return
     */
    public static  boolean updateIndex(String key, long index,Object value) {
        try {
