 ...
 * under the License.                                           *
 ****************************************************************/
package throner.myspringboot.tool.es.dsl.query.builder;

import com.google.gson.JsonObject;
import throner.myspringboot.tool.es.dsl.query.builder.filter.DSLFilter;
import throner.myspringboot.tool.es.dsl.query.builder.query.DSLFilteredQuery;
import throner.myspringboot.tool.es.dsl.query.builder.query.DSLMatchAllQuery;
import throner.myspringboot.tool.es.dsl.query.builder.query.DSLQuery;
